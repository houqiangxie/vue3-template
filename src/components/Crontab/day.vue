<template>
  <n-radio-group v-model:value="radioValue" class="cron-radio-group">
    ...
    <div class="cron-option">
      <n-radio :value="3">
        周期从
        <n-input-number v-model:value="cycle01" class="cron-input-number" size="small" :min="1" :max="30" />
        -
        <n-input-number v-model:value="cycle02" class="cron-input-number" size="small" :min="cycle01 + 1" :max="31" />
        日
      </n-radio>
    </div>
    ...
    <div class="cron-option">
      <n-radio :value="4">
        从
        <n-input-number v-model:value="average01" class="cron-input-number" size="small" :min="1" :max="30" />
        号开始，每
        <n-input-number
    ...
    <div class="cron-option">
      <n-radio :value="5">
        每月
        <n-input-number v-model:value="workday" class="cron-input-number" size="small" :min="1" :max="31" />
        号最近的那个工作日
      </n-radio>
    </div>
