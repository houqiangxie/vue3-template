<template>
  <div>
    ...
    <n-form-item label="启用开关" path="timeoutHandlerEnable">
      <n-switch
        v-model:value="timeoutHandlerEnable"
        @change="timeoutHandlerChange"
      />
    </n-form-item>
    <n-form-item label="执行动作" path="timeoutHandlerType" v-if="timeoutHandlerEnable">
      <n-radio-group v-model:value="timeoutHandlerType.value" @change="onTimeoutHandlerTypeChanged">
        <n-radio-button
    ...
    <n-form-item label="超时时间设置" v-if="timeoutHandlerEnable">
