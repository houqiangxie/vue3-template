...
export const roles: SysRole[] = [
  ...
  },
  {
    ...
    roleSort: 2,
    status: '1',
    menuIds: [1, 2, 3, 4, 73, 5, 6, 10, 14, 21, 26, 34, 35, 41, 44],
    remark: '普通业务人员',
    createTime: '2024-01-01 00:00:00',
  },
]
...
export const menus: SysMenu[] = [
  { menuId: 1, parentId: 0, menuName: '系统首页', menuType: 'M', orderNum: 1, path: '/Index', icon: 'HomeOutlined', visible: '1', status: '1', createTime: '2024-01-01 00:00:00' },
  { menuId: 2, parentId: 1, menuName: '首页', menuType: 'C', orderNum: 1, path: '/Index/HomeIndex', component: 'Index/HomeIndex', perms: 'index:home:view', icon: 'HomeOutlined', visible: '1', status: '1', isCache: '1', createTime: '2024-01-01 00:00:00' },
  { menuId: 3, parentId: 1, menuName: 'Modal 示例', menuType: 'C', orderNum: 2, path: '/Index/ModalDemo', component: 'Index/ModalDemo', perms: 'index:modal:view', visible: '1', status: '1', isCache: '1', createTime: '2024-01-01 00:00:00' },
  { menuId: 4, parentId: 1, menuName: '个人信息', menuType: 'C', orderNum: 3, path: '/Index/PersonInfo', component: 'Index/PersonInfo', perms: 'index:person:view', visible: '1', status: '1', isCache: '1', createTime: '2024-01-01 00:00:00' },
  { menuId: 73, parentId: 1, menuName: 'AI 助手', menuType: 'C', orderNum: 4, path: '/Index/AiChat', component: 'Index/AiChat', perms: 'index:ai:chat', icon: 'RobotOutlined', visible: '1', status: '1', isCache: '1', createTime: '2024-01-01 00:00:00' },
  { menuId: 5, parentId: 0, menuName: '系统管理', menuType: 'M', orderNum: 2, path: '/System', icon: 'SettingOutlined', visible: '1', status: '1', createTime: '2024-01-01 00:00:00' },
  ...
  { menuId: 33, parentId: 0, menuName: '系统监控', menuType: 'M', orderNum: 3, path: '/Monitor', icon: 'MonitorOutlined', visible: '1', status: '1', createTime: '2024-01-01 00:00:00' },
